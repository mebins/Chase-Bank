      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
           ...
           ?>
              <form method = "post" action = "php-calls/register.inc.php" class="user">
                ...
                <input type="submit" name="register-submit" value="register" class="btn btn-primary btn-user btn-block"/>
                <hr>
              <div class="text-center">
